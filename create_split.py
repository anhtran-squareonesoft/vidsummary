...
from util.file_process import write_json

parser = argparse.ArgumentParser("Code to create splits in json form")
parser.add_argument("-d", "--dataset", type=str, default='dataset_tvsum/data.h5', help="path to h5 dataset (required)")
parser.add_argument("--save-dir", type=str, default='dataset_tvsum', help="path to save output jon file (default: 'datasets/'")
